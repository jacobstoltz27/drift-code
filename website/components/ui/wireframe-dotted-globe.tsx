...
export default function RotatingEarth({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      context.fill();
      context.strokeStyle = "#AFD2FA";
      context.lineWidth = 1.5 * scaleFactor;
      context.stroke();

      if (landFeatures) {
        // Draw graticule (powder blue, faint)
        ...
        // Draw land outlines (powder blue)
        context.beginPath();
        ...
        // Draw halftone dots (vibrant sky blue)
        allDots.forEach((dot) => {
    ...
    return (
      ...
      >
        <div className="text-center">
          <p className="mb-2 font-semibold text-ivory">
            The globe is drifting off course
          </p>
  ...
  return (
    <div className={`relative ${className}`}>
      <canvas
        ref={canvasRef}
        className="h-auto w-full cursor-grab rounded-2xl active:cursor-grabbing"
